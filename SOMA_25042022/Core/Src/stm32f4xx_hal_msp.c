...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB9     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(BT_WIFI_SCL_GPIO_Port, BT_WIFI_SCL_Pin);

    HAL_GPIO_DeInit(BT_WIFI_SDA_GPIO_Port, BT_WIFI_SDA_Pin);
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PF1     ------> I2C2_SCL
    */
    HAL_GPIO_DeInit(HP_SPKR_SDA_GPIO_Port, HP_SPKR_SDA_Pin);

    HAL_GPIO_DeInit(HP_SPKR_SCL_GPIO_Port, HP_SPKR_SCL_Pin);
...
void HAL_I2S_MspDeInit(I2S_HandleTypeDef* hi2s)
{
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PC6     ------> I2S2_MCK
    */
    HAL_GPIO_DeInit(GPIOB, I2S_LRCLK_Pin|I2S_CLK_Pin|I2S_SDI_Pin|I2S_SDO_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    PC12     ------> SPI3_MOSI
    */
    HAL_GPIO_DeInit(GPIOC, SD_SPI3_CLK_Pin|SD_SPI3_MISO_Pin|SD_SPI3_MOSI_Pin);
  ...
  /* USER CODE END SPI5_MspDeInit 0 */
    ...
    PF9     ------> SPI5_MOSI
    */
    HAL_GPIO_DeInit(GPIOF, BT_WIFI_SPI_SCK_Pin|BT_WIFI_SPI_MISO_Pin|BT_WIFI_SPI_MOSI_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART7_MspDeInit 0 */
    ...
    PE8     ------> UART7_TX
    */
    HAL_GPIO_DeInit(GPIOE, DBG_UART_RX_Pin|DBG_UART_TX_Pin);
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PA10     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, LCD_UART_TX_Pin|LCD_UART_RX_Pin);
